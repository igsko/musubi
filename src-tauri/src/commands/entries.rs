// This file contains Tauri IPC command handlers for dictionary entry operations.
// It handles database searches for prefix suggestions, fetching entry details JSON, and batch record retrieval.
