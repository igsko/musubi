...
<div class="custom-titlebar" data-tauri-drag-region>
  ...
  <!-- we do not put the drag region attribute on the controls container -->
  <div class="window-controls">
    ...
    <button class="control-btn close-btn" onclick={closeWindow} aria-label="Close">
      <svg width="12" height="12" viewBox="0 0 12 12"><polygon points="10,2.7 9.3,2 6,5.3 2.7,2 2,2.7 5.3,6 2,9.3 2.7,10 6,6.7 9.3,10 10,9.3 6.7,6" fill="currentColor"/></svg>
    </button>
  </div>
</div>
